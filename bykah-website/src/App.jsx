  ...
  return (
    <div style={{ background: "#060E1A", color: "#CBD5E8", fontFamily: "'DM Sans',sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        background: scrollY > 60 ? "rgba(6,14,26,0.97)" : "transparent",
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
          <div>
            <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 20, color: "#E8D5A3", fontWeight: 700, letterSpacing: "0.01em", lineHeight: 1 }}>Buy Your Kids</div>
            <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 11, color: "#C9973A", letterSpacing: "0.25em", textTransform: "uppercase" }}>A House</div>
          </div>
      ...
      {/* ── HERO ── */}
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", padding: "120px 40px 80px", overflow: "hidden" }}>
        {/* Background orbs */}
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 68, lineHeight: 1.05, color: "#E8D5A3", fontWeight: 700, marginBottom: 24 }}>
              Help Your Kids<br />
            ...
            <div style={{ display: "flex", gap: 40 }}>
              {[["47+", "Episodes"], ["12K+", "Subscribers"], ["Free", "Tools"]].map(([n, l]) => (
                <div key={l}>
                  <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 32, color: "#E8D5A3", fontWeight: 700 }}>{n}</div>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ background: "linear-gradient(135deg,rgba(201,151,58,0.12),rgba(201,151,58,0.03))", border: "1px solid rgba(201,151,58,0.2)", borderRadius: 24, padding: 36 }}>
              ...
              <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 52, color: "#E8D5A3", fontWeight: 700, marginBottom: 6 }}>$85,714</div>
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 48, color: "#E8D5A3", fontWeight: 700, marginBottom: 14 }}>Start Here — It's Free</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, marginBottom: 60 }}>
            {TOOLS.map((tool, i) => (
              <FadeIn key={tool.title} delay={i * 0.15}>
                <div className="tool-card" style={{ background: "rgba(255,255,255,0.03)", border: `1px solid rgba(255,255,255,0.08)`, borderRadius: 20, padding: 36, position: "relative", overflow: "hidden" }}>
      ...
      {/* ── THE APP ── */}
      <section style={{ padding: "100px 40px", background: "rgba(255,255,255,0.02)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 64, flexWrap: "wrap", gap: 24 }}>
              <div>
                ...
                <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 48, color: "#E8D5A3", fontWeight: 700, maxWidth: 520 }}>One App. Five Modules. Your Entire Financial Future.</h2>
              </div>
          ...
          <FadeIn>
            <div style={{ background: "linear-gradient(135deg,rgba(201,151,58,0.1),rgba(201,151,58,0.03))", border: "1px solid rgba(201,151,58,0.2)", borderRadius: 20, padding: "36px 40px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 40, flexWrap: "wrap" }}>
              <div>
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 48, color: "#E8D5A3", fontWeight: 700, marginBottom: 14 }}>New Episodes Every Week</h2>
          ...
          <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 20, overflow: "hidden" }}>
            {EPISODES.map((ep, i) => (
              <FadeIn key={ep.ep} delay={i * 0.07}>
                <div className="ep-row" onClick={() => setPlayingEp(playingEp === ep.ep ? null : ep.ep)}
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <FadeIn>
            <div>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 52, color: "#E8D5A3", fontWeight: 700, lineHeight: 1.1, marginBottom: 20 }}>The Book is<br /><span style={{ fontStyle: "italic" }}>Coming.</span></h2>
          ...
          <FadeIn delay={0.2}>
            <div style={{ position: "relative" }}>
              {/* Book mockup */}
              <div style={{ background: "linear-gradient(135deg,#1A2B4A,#0D1B2E)", border: "1px solid rgba(201,151,58,0.3)", borderRadius: 8, padding: "60px 40px", textAlign: "center", boxShadow: "-12px 12px 40px rgba(0,0,0,0.5), 0 0 60px rgba(201,151,58,0.08)", position: "relative", overflow: "hidden" }}>
      ...
      <section style={{ padding: "100px 40px", borderTop: "1px solid rgba(255,255,255,0.05)", textAlign: "center" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <FadeIn>
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 52, color: "#E8D5A3", fontWeight: 700, lineHeight: 1.1, marginBottom: 20 }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "40px 40px" }}>
